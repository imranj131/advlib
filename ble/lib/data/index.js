...
var slaveconnectionintervalrange = require('./gap/slaveconnectionintervalrange.js');
...
var tagdatalength = require('./gap/tagdatalength.js');
var txpower = require('./gap/txpower.js');
var reversebytes = require('./gap/reversebytes.js');
  ...
  while(cursor < advertiserDataLength) {
    ...
    switch(tag) {
      case("01"):
        ...
        break;
      case("02"):
        uuid.process(payload, cursor, advertiserData);
        break;
      case("03"):
        uuid.process(payload, cursor, advertiserData);
        break;
      case("04"):
        genericdata.process(payload, cursor, advertiserData, "nonComplete32BitUUIDs");
        break;
      case("05"):
        genericdata.process(payload, cursor, advertiserData, "complete32BitUUIDs");
        break;
      case("06"):
        uuid.process(payload, cursor, advertiserData);
        break;
      case("07"):
        ...
        break;
      case("08"):
        localname.process(payload, cursor, advertiserData);
        break;
      case("09"):
        localname.process(payload, cursor, advertiserData);
        break;
      ...
      case("0d"):
        ...
        break;
      case("0e"):
        genericdata.process(payload, cursor, advertiserData, "simplePairingHashC");
        break;
      case("0f"):
      ...
      case("12"):
        ...
        break;
      case("14"):
        solicitation.process(payload, cursor, advertiserData);
        break;
      case("15"):
        solicitation.process(payload, cursor, advertiserData);
        break;
